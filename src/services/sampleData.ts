...
export const sampleChildren: ChildProfile[] = [
  { id: "anaya", display_name: "Anaya", age_band: "5-7", daily_time_limit_minutes: 30, voice_enabled: true, child_pin_enabled: false },
  { id: "vihaan", display_name: "Vihaan", age_band: "8-10", daily_time_limit_minutes: 40, voice_enabled: true, child_pin_enabled: true },
  { id: "meera", display_name: "Meera", age_band: "11-12", daily_time_limit_minutes: 45, voice_enabled: false, child_pin_enabled: false }
];
